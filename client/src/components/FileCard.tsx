...
const FileCard: React.FC<FileCardProps> = ({ file }) => {
    ...
    return (
        <li className="relative w-full flex flex-col gap-6 bg-white px-6 py-6 rounded-[10px] border border-slate-200 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex flex-1 items-start gap-4">
                <div className="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-[10px] bg-slate-100 text-slate-500">
                ...
                <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-3 flex flex-wrap items-center gap-2 text-xs text-slate-500">
                        <span className="rounded-lg bg-white border border-slate-200 px-2 py-1 text-slate-900">
            ...
            <div className="absolute top-6 right-6 flex gap-2">
                <button
                    type="button"
                    className="inline-flex items-center gap-2 rounded-lg bg-white px-4 py-2 text-sm font-medium text-black transition hover:bg-slate-50"
                >
                    {file.isPublic ? (
