        ...
        <div className="flex flex-wrap items-start justify-between gap-6">
          <div className="flex min-w-[22rem] flex-1 gap-4">
            ...
            <div className="flex flex-col gap-2">
              <h1 className="font-segoe-ui text-[2rem] leading-9 text-slate-900">{project.name}</h1>
              <a href="#" className="w-fit text-sm text-scrumdone-blue-main hover:underline">
                {project.clientName}
              </a>
              <p className="text-[1.75rem]/7 font-light text-slate-600">{project.description}</p>
              ...
              <div className="mt-1 flex flex-wrap items-center gap-6 text-slate-600">
                ...
                <div className="inline-flex items-center gap-2 text-base">
                  ...
                  {project.membersCount} czlonkow zespolu
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex min-w-56 flex-col items-stretch gap-3">
            <div className="inline-flex w-full rounded-xl border border-slate-200 bg-slate-100 p-1">
              <button className="flex-1 rounded-lg bg-white px-4 py-2 text-sm font-medium text-slate-900">Kanban</button>
              <button className="flex-1 rounded-lg px-4 py-2 text-sm font-medium text-slate-700">Scrum</button>
            </div>

            <button className="inline-flex w-full items-center justify-center gap-2 rounded-lg border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium text-slate-900 hover:bg-slate-50">
