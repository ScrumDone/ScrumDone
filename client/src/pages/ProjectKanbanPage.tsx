        ...
        <div className="flex w-full flex-col">
          {project ? (
            <>
              ...
              <section className="mx-6 mt-6 rounded-[14px] border border-slate-200 bg-white p-6 text-slate-700">
                Tablica Kanban dla projektu {project.name} zostanie dodana w następnym kroku.
              </section>
            </>
          ) : (
