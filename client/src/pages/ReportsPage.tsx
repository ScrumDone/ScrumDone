                ...
                <div className="mx-auto max-w-7xl px-8 py-8">
                    ...
                    <section className="rounded-2xl border border-slate-200 bg-white px-6 py-12">
                        <div className="mx-auto flex max-w-xl flex-col items-center text-center">
                            <DocumentTextIcon className="mb-4 h-16 w-16 text-slate-400" />
                            <h2 className="mb-3 font-segoe-ui text-[36px] leading-9 font-normal text-slate-900 antialiased">
                                Brak raportow
                            </h2>
                            <p className="mb-8 font-segoe-ui text-[32px] leading-8 font-normal text-slate-600 antialiased">
