        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentAssignmentId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Assignment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Assignment_AssignmentPriorities_PriorityId",
                        column: x => x.PriorityId,
                        principalTable: "AssignmentPriorities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Assignment_AssignmentStatuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "AssignmentStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Assignment_Assignment_ParentAssignmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssignmentAssignmentLabelMTMTable_Assignment_AssignmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssignmentUserMTMTable_Assignment_AssignmentId",
                        column: x => x.AssignmentId,
                        principalTable: "Assignment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignment_ParentAssignmentId",
                table: "Assignment",
                column: "ParentAssignmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Assignment_PriorityId",
                table: "Assignment",
                column: "PriorityId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Files_Assignment_AssignmentId",
                table: "Files",
                column: "AssignmentId",
                principalTable: "Assignment",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Messages_Assignment_AssignmentId",
                table: "Messages",
                column: "AssignmentId",
                principalTable: "Assignment",
                principalColumn: "Id",
